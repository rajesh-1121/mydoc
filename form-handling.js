...
handleLogin('patientLoginForm', 'login_patient.php', 'patient');
handleSignup('patientSignupForm', 'register_patient.php', 'patient');
handleLogin('doctorLoginForm', 'login_doctor.php', 'doctor');
handleSignup('doctorSignupForm', 'register_doctor.php', 'doctor');
